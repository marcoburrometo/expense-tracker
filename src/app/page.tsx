  ...
  return (
    <main className="app-content-wrap w-full py-4 md:py-8 space-y-6 flex flex-col flex-1 min-h-0">
      ...
      <div className="grid gap-6 lg:grid-cols-5 flex-1 min-h-0">
        <div className="lg:col-span-3 space-y-6 h-full flex flex-col min-h-0 max-w-[95vw]">
          <div className="glass-panel p-2 md:p-3 fade-in flex-1 min-h-0 flex flex-col" style={{ animationDelay: '.1s' }}>
            <MovementTable />
          </div>
        </div>
        <div className="lg:col-span-2 space-y-6 fade-in max-w-[95vw]" style={{ animationDelay: '.15s' }}>
          <LedgerChart />
        </div>
      </div>
    </main>
