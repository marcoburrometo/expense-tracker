...
export const Navbar: React.FC = () => {
  ...
  return (
    <GlassPanel as="nav" variant="flat-pure" className="w-full px-4 md:px-6 py-2.5 flex items-center gap-3 md:gap-6 text-sm relative overflow-visible">
      {/* Brand / Logo placeholder */}
      <div className="flex items-center gap-2 font-semibold tracking-tight text-accent relative">
        <span className="text-accent text-[15px] leading-none">💰</span>
        <span className="hidden sm:inline text-primary">Expense<span className="text-accent">Tracker</span></span>
      </div>
